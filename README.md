...
## Changes by Lorol
[![converter-tool](resources/converter-tooltool.png)](https://rawgit.com/lorol/esp8266-weather-station-color/master/resources/converter-tool/display.htm)
* Added converter tool (click the picture above) to generate C code from own images. 
* Alternative set of icons - weathericons2.h - generated by this converter tool. 
